...
ALTER DATABASE boutiquecegep OWNER TO "Groupe Boutique";
...
ALTER TABLE public.produit OWNER TO kenny;

--
-- TOC entry 202 (class 1259 OID 16390)
-- Name: produit_id_seq; Type: SEQUENCE; Schema: public; Owner: kenny
--
...
ALTER TABLE public.produit_id_seq OWNER TO kenny;

--
-- TOC entry 2934 (class 0 OID 0)
-- Dependencies: 202
-- Name: produit_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: kenny
--
...
-- Name: produit id; Type: DEFAULT; Schema: public; Owner: kenny
--
...
-- Dependencies: 203
-- Data for Name: produit; Type: TABLE DATA; Schema: public; Owner: kenny
--
...
-- Dependencies: 202
-- Name: produit_id_seq; Type: SEQUENCE SET; Schema: public; Owner: kenny
--
...
-- Name: produit produit_pkey; Type: CONSTRAINT; Schema: public; Owner: kenny
--
