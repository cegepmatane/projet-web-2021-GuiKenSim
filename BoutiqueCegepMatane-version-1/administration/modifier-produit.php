	...
	<?php include "menu-administration.php"?>
  	...
  	<div class="contenu">
		<div class="contenu-image">
			<img src="../Ressources/images/<?=$produit->getImage();?>" alt="logo-item" >
		</div>
		...
		<form class="produit-formulaire" action="./accesseur/traitement-modifier-produit.php" method="POST" enctype="multipart/form-data">
			<div class="champ">
				...
				<div class="input-contenant">
					<input class="input" type="text" name="titre" value="<?=$produit->getTitre()?>"/>
				</div>
			</div>
			<div class="champ">
				<div class="label-contenant">
				...
				<div class="input-contenant">
					<input class="input" type="text" name="prix" value="<?=$produit->getPrix()?>"/>
				</div>
			</div>
			<div class="champ">
				...
				<div class="input-contenant-description">
					<textarea class="textarea-description" name="description"> <?=$produit->getDescription()?> </textarea>
				</div>
			</div>
			<div class="champ">
				<div class="label-contenant"> 
			...
			<div class="champ">
				...
				<input type="hidden" name="image" value=<?=$produit->getImage();?> />
